...
{
    public partial class CriacaoDB2021 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Serviços_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicoPredios_Serviços_ServicoId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ea8dab3a-48aa-46da-b2f1-c877831f2406", "07c4e550-99ef-4718-ae8d-3a4508029421", "Morador do Prédio", "Morador", "MORADOR" },
                    { "60497a21-7ede-4352-8419-2412a4744b7e", "452c98fb-49c8-484b-9fa5-7b476886c1b2", "Síndico do Prédio", "Síndico", "SINDICO" },
                    { "6b77d7d3-a297-4d76-8d20-3e6a83f46473", "6cdfd0b4-a368-4b3f-9978-0d12d552074c", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
